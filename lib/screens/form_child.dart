...
import 'package:stage/screens/questionnaire_page.dart';
...
class _FormParentPageState extends State<FormParentPage> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate() &&
      ...
      String parentRole = _getParentName();
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => ParentInfoPage(
            ...
            childFirstName: _firstNameController.text,
            childLastName: _lastNameController.text,
